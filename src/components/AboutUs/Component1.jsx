    ...
    return (
        <div className="relative flex md:h-[660px]">
            ...
            <div className="relative z-10 text-left py-[50px] pl-[32px] md:pl-[64px] md:pt-[80px]">
                {/* Subtitle */}
                <div className="fontMontserrat text-sm text-customBlueishBlack md:text-2xl font-normal leading-[33.6px] tracking-[5%] pb-3">
                ...
                {/* <div className="fontExo text-left font-extrabold text-3xl md:text-[72px] leading-[2.5rem] md:leading-[89.6px] tracking-[-1%]  text-customBlueishBlack">
                 ...
                 <div className="fontExo text-left font-extrabold text-3xl md:text-[63px] leading-[2.5rem] md:leading-[89.6px]  text-customBlueishBlack max-w-[300px] md:max-w-[1000px]">
                ...
                <img
                    ...
                    alt="chair"
                    // className="absolute w-72 h-90 md:w-96 md:h-112 top-[227px] left-[px] md:top-[227px] md:left-[738px] p-10"
                    // className="absolute w-96 h-112 md:top-[227px] md:left-[738px] hidden md:block md:py-10"
                    // className="absolute w-96 h-112 md:top-[200px] md:left-[738px]  md:pb-20 hidden md:block"
